...
import { Heading, Container, Flex, Box, UnorderedList, ListItem } from "@chakra-ui/react"
...
export const Services = () => {
  return (
    <div className="banner">
      <Container maxW="8xl">
        ...
        <Flex justifyContent={"space-around"}  py="40px"
            color={"#FEFEFE"}>
          <Box>
            <Heading  fontWeight={600}
            fontSize={["22px", "22px", "22px", "26px"]}>MANAGED</Heading>
  ...
  <ListItem>Creative Implementation & QA
</ListItem>
  ...
  <ListItem>Header Bidding</ListItem>
          ...
          <Box><Heading  fontWeight={600}
            fontSize={["22px", "22px", "22px", "26px"]}>PROFESSIONAL</Heading> 
             <UnorderedList mt="22px">
  ...
  <ListItem>Platform integrations
</ListItem>
